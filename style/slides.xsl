...
<xsl:import href="../style/scrum-tools/capacity-template.xsl" />
<xsl:import href="../style/scrum-tools/credibility-template.xsl" />
<xsl:import href="../style/scrum-tools/metrics-template.xsl" />
<xsl:import href="../style/scrum-tools/burndown-template.xsl" />
<xsl:import href="../style/scrum-tools/chucknorris-template.xsl" />
<xsl:import href="../style/scrum-tools/fetch-thisrelease.xsl" />
<xsl:import href="../style/scrum-tools/fetch-thissprint.xsl" />
<xsl:import href="../style/slide-tools/story-slide-template.xsl" />

    <xsl:output method="html" encoding="utf-8" indent="yes" />
    <xsl:template match="/" > 
        <xsl:variable name="sprintfolder" select="/sprintreview/@folder" /><!-- sprintfolder of the current review -->
        <xsl:variable name="teamfolder" select="/sprintreview/team/@name" />
        ...
        <html>
            <head>
                ...
                <!-- This script is creating an error in IE, I'm not sure if it is even used -->
                <!--
            ...
            <body class="tomtom-container">
                ...
                <div class="reveal">
                    <div class="slides">
                        ...
                        <xsl:for-each select="sprintreview/team">
                            <section class="slide"  data-transition="zoom" data-background-image="../../style/prodata/img/master31.jpg"><!-- First TomTom group slide. -->
                                <table align="center">
                                    ...
                                    <tr><td align="right"><h4 class="center" style="color:white;">Release: <xsl:value-of select="$thisreleasename" /></h4></td><td align="left"><h4 class="center"></h4></td></tr>
                                </table>
                            </section>
                            <section class="slide" align="left"><!-- Team slide. -->
                                ...
                                <table align="center">
                                        ...
                                        <tr><td align="center">
                                            ...
                                            <td>
                                                <table>
                                                <tr><td align="right"><h4 class="center">Capacity trend for <xsl:value-of select="$teamfolder" /></h4></td></tr>
                                                <tr><td align="right">
                                                        <xsl:call-template name="capacity-template">
                                                            <xsl:with-param name="teamname" select="$teamfolder" />
                                        ...
                                        <table width="100%" style="line-height:100%">
                                            <xsl:for-each select="sprintreview/stories/story[@state='story not-done']">
                                                <tr class="story not-done">
                                                    <td width="75%"><xsl:value-of select="@title" /></td>
                                                    <td width="10%">(SP: <xsl:value-of select="@points" />)</td>
                      ...
                      <xsl:for-each select="sprintreview/metrics/metric">
                        <section class="slide" data-transition="zoom" style="{@style} text-align: left;">
                          <h3 class="center">Code Metrics for <xsl:value-of select="@project"/></h3>
                          
                          <xsl:call-template name="code-metrics-template">
                            <xsl:with-param name="teamname" select="$teamfolder" />
                            <xsl:with-param name="teamfolder" select="$teamfolder" />
                            <xsl:with-param name="releasedoc" select="$releasedoc" />
                            <xsl:with-param name="thissprintfolder" select="$sprintfolder" />
                        ...
                        <section class="slide" style="text-align: left;"> <!-- show its burn down, with their respective sums --> 
                            <table align="center">
                                ...
                                <tr><td><br/></td></tr>
                                <tr><td><h4 class="center">Credibility Trend for <xsl:value-of select="$teamfolder" /></h4>
